---
name: xterm-pty
description: xterm.js 6.0 + portable-pty terminal patterns for jig
---
...
jig uses xterm.js 6.0 for terminal rendering and portable-pty (Rust) for cross-platform PTY management. The PTY runs user's shell, and AI agents are launched as commands within it.
