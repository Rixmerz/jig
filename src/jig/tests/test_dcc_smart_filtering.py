"""Tests for _get_new_files and _filter_actionable_smells in dcc_integration.py."""
import time
from unittest.mock import patch, MagicMock

import pytest

from jig.engines.dcc_integration import _get_new_files, _filter_actionable_smells
